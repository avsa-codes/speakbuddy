...
export type StorageHash =
  StorageHashBase<'308a21fa409ef92c5fbd783fe118bfe505d11b3c9fd3dc09cb9fafdf4b883ff0'>;
export type ExecutionHash =
  ExecutionHashBase<'85435f1d509feb4b0acede1f5955bc886b580ad213cfcb4cda5cea5f3dace1b1'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly GroupReservation: {
      ...
      readonly reservedAt: CodecTypes['pg/timestamptz-string@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly GroupReservation: {
      ...
      readonly userId: CodecTypes['pg/text@1']['input'];
      readonly status: 'RESERVED' | 'CONFIRMED' | 'CANCELLED' | 'EXPIRED';
      readonly reservedAt: CodecTypes['pg/timestamptz-string@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly groupDiscussion: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'groupDiscussion_scheduledStartAt_idx_16bf47c9';
                  readonly prefix: 'groupDiscussion_scheduledStartAt_idx';
            ...
            readonly groupReservation: {
              ...
              indexes: readonly [
                {
                  readonly name: 'groupReservation_groupDiscussionId_idx_772d1f81';
                  readonly prefix: 'groupReservation_groupDiscussionId_idx';
                  readonly columns: readonly ['groupDiscussionId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'groupReservation_userId_idx_a489d58a';
                  readonly prefix: 'groupReservation_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'groupReservation_status_idx_e98638ab';
                  readonly prefix: 'groupReservation_status_idx';
                  readonly columns: readonly ['status'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'groupReservation';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            ...
            readonly ReservationStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['RESERVED', 'CONFIRMED', 'CANCELLED', 'EXPIRED'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly groupReservation: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'GroupReservation';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly GroupReservation: {
            ...
            readonly storage: {
              readonly table: 'groupReservation';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly groupDiscussionId: { readonly column: 'groupDiscussionId' };
